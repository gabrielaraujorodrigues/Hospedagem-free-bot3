...
if (qr != 0 && qr != undefined) {
try {
const _QRCode = (await import('qrcode')).default
const _dataUri = await _QRCode.toDataURL(qr, { margin: 1, width: 300 })
process.stdout.write('__QR_BASE64__:' + _dataUri + '\n')
} catch (_e) {}
}
